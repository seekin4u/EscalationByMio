...
/datum/map/coldwar
	...
	station_levels = list(1,2, 3, 4) //1, 2 - USMC and CA armies bunkers if gamemode isn't company
	admin_levels = list()
	contact_levels = list() //the third level is main battleground| levels which can be reached for e.g. announsments
