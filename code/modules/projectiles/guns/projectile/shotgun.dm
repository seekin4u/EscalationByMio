/obj/item/weapon/gun/projectile/shotgun
	reload_sound = 'sound/weapons/gunporn/shotgun_insert.ogg'
...
/obj/item/weapon/gun/projectile/shotgun/pump
	...
	var/casingsound = 'sound/weapons/gunporn/shotgun_fall.ogg' //Same here.
...
/obj/item/weapon/gun/projectile/shotgun/doublebarrel/attackby(var/obj/item/A as obj, mob/user as mob)
	if(w_class > 3 && (istype(A, /obj/item/weapon/circular_saw) || istype(A, /obj/item/weapon/melee/energy) || istype(A, /obj/item/weapon/pickaxe/plasmacutter)))
		...
		if(do_after(user, 30, src))	//SHIT IS STEALTHY EYYYYY
			...
			slot_flags |= SLOT_BELT //but you can wear it on your belt (poorly concealed under a trenchcoat, ideally) - or in a holster, why not.
...
/obj/item/weapon/gun/projectile/shotgun/pump/boltaction
	...
	item_state = "mosin"
	caliber = "a762"
	reload_sound 	= 'sound/weapons/gunporn/rifle_load.ogg'
	casingsound = 'sound/weapons/casingfall1.ogg'
