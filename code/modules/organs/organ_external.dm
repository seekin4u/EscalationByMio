...
/obj/item/organ/external/proc/fracture()
	...
	playsound(owner, "trauma", 100, 0)//ouch
	status |= ORGAN_BROKEN
	broken_description = pick("broken")//,"fracture","hairline fracture") //Multiple fracture names is just confusing. It's broken so call it broken.
