/datum/hud_data
	...
	var/list/gear = list(
		"uniform" =      list("loc" = ui_iclothing, "name" = "Uniform",      "slot" = slot_w_uniform, "state" = "center", "toggle" = 1),
		"suit" =         list("loc" = ui_oclothing, "name" = "Armor",        "slot" = slot_wear_suit, "state" = "suit",   "toggle" = 1),
		...
		"head" =         list("loc" = ui_head,      "name" = "Helmet",       "slot" = slot_head,      "state" = "hair",   "toggle" = 1),
		"shoes" =        list("loc" = ui_shoes,     "name" = "Shoes",        "slot" = slot_shoes,     "state" = "shoes",  "toggle" = 1),
		"pouch" =        list("loc" = ui_sstore1,   "name" = "Pouch",        "slot" = slot_s_store,   "state" = "suitstore"),
		"storage" =      list("loc" = ui_back,      "name" = "Storage",      "slot" = slot_back,      "state" = "back"),
		"utility" =      list("loc" = ui_id,        "name" = "Utility",      "slot" = slot_wear_id,   "state" = "id"),
		"gun" =          list("loc" = ui_gun_slot,  "name" = "Gun",          "slot" = slot_add_gun,   "state" = "wear_gun"),
		"pocket1" =      list("loc" = ui_storage1,  "name" = "Left Pocket",  "slot" = slot_l_store,   "state" = "pocket"),
		"pocket2" =      list("loc" = ui_storage2,  "name" = "Right Pocket", "slot" = slot_r_store,   "state" = "pocket"),
