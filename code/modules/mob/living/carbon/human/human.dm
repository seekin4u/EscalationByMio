...
var/list/ranks_prefixes = list(\
	"Poruchik" = "Por.", \
	"Podporuchik" = "Podp.", \
	"Druzhstvo Radista" = "Des.", \
	"Chetar" = "Chet.", \
	"Subchetar" = "Des.", \
	"Delostrelec" = "Svob.", \
	"Pancerovnik" = "Svob.", \
	"Pomocnik pancerovnika" = "Voj.", \
	"Radista" = "Voj.", \
	"Strelec" = "Voj.", \
	"Nadstrelec" = "Svob.", \
	"Sanitar" = "Des.", \
	...
	"Komandir Vzvoda" = "Leyt.", \
	"Zamkomvzvoda" = "Starsh.", \
	"Kapter" = "Prap.", \
	"Zampolit" = "Leyt.", \
	"Pomoshnik Kaptera" = "Yefr.", \
	"Vzvodny Radist" = "Yefr.", \
	"Komandir Otdeleniya" = "Serzh.", \
	"Starshiy Strelok" = "Yefr.", \
	"Radiotelefonist" = "Ryad.", \
	"Granatometchik" = "Ryad.", \
	"Pomoshnik granatometchika" = "Ryad.", \
	"Pulemetchik" = "Ryad.", \
	"Strelok" = "Ryad.", \
	"Snayper" = "Yefr.", \
	"Glavvrach" = "Ml. Leyt.", \

	"Komandir rascheta" = "Serzh.", \
	"Strelok Rascheta" = "Ryad.", \
	"Assistent Rascheta" = "Ryad.", \
	"Vzvodny Pulemetchik" = "Ryad.", \
	"Comandir Razvedotdeleniya" = "Serzh.", \
	"Zamkomandira Razvedotdeleniya" = "Yefr.", \
	"Razvedchik-Radist" = "Ryad.", \
	"Razvedchik-Snayper" = "Yefr.", \
	"Razvedchik" = "Ryad.", \
	...
	"HWS Gunner" = "PFC.", \
	"HWS Assistant" = "PFC.", \
	"Assault Squad Commander" = "Cpl.", \
	"Grenadier" = "PFC.", \
	"Grenadier Assistant" = "PFC.", \
