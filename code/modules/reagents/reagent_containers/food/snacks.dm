	...
	if(istype(M, /mob/living/carbon))
		...
		if(C == user)								//If you're eating it yourself
			if(istype(C,/mob/living/carbon/human))
				...
				if(blocked)
					to_chat(user, "<span class='warning'>\The [blocked] is on the way!</span>")
					return
...
/obj/item/weapon/reagent_containers/food/snacks/armymaindish/crackers_sov
	name = "galetes"
...
/obj/item/weapon/reagent_containers/food/snacks/armymaindish/crackers
	name = "crackers"
