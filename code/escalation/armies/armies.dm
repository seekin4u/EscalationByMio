...
/obj/item/weapon/addtowhitelist
	name = "whitelist add"

/obj/item/weapon/addtowhitelist/verb/add_player_to_whitelist()
	set name = "add wl"
	set category = "IC"
	set desc = "add wl"
	set src in usr

	var/ckey_in = input("ckey","ckey")
	var/rank_in = input("rank.","rank")

	add_player_to_escalation_whitelist(ckey_in, rank_in)
*/